...
public class TodoFragment extends Fragment implements ITodoView, View.OnClickListener{
    ...
    private void initView() {
        ...
        search_fab =  root.findViewById(R.id.todo_search_fab);
        swipeRefreshLayout = root.findViewById(R.id.swiperefresh5);
    }
    ...
    private void initPresenter() {
        todoPresenter = new TodoPresenter(this, mContext);
    }
                ...
                AlertDialog dialog = new AlertDialog.Builder(mContext)
                        ...
                        .setPositiveButton("Search", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                todoPresenter.searchTodoById(id);
                            }
                        })
    ...
    public void showNotFound() {
        Toast.makeText(mContext, "Todo not Found", Toast.LENGTH_SHORT).show();
    }
